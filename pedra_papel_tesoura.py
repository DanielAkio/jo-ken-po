def main():
    ...
    while jogar_novamente == "1":
        um_monte_de_espaco()
        jogada_do_primeiro_jogador = validar_jogada(
            pergunta_jogada_do_primeiro_jogador(primeiro_jogador)
        )
        ...
        um_monte_de_espaco()
        jogada_do_segundo_jogador = validar_jogada(
            pergunta_jogada_do_segundo_jogador(segundo_jogador)
        )
        ...
        um_monte_de_espaco()
        jogada_do_primeiro_jogador_palavra = qual_o_primeiro_jogador_jogou(
            jogada_do_primeiro_jogador
        )
        jogada_do_segundo_jogador_palavra = qual_o_segundo_jogador_jogou(
            jogada_do_segundo_jogador
        )
        mostra_o_que_cada_um_jogou(
            primeiro_jogador,
            segundo_jogador,
            jogada_do_primeiro_jogador_palavra,
            jogada_do_segundo_jogador_palavra,
        )
        quem_ganhou(
            primeiro_jogador,
            segundo_jogador,
...
def mostra_o_que_cada_um_jogou(
    primeiro_jogador,
    segundo_jogador,
    jogada_do_primeiro_jogador,
    jogada_do_segundo_jogador,
    ...
    print(
        f"O {primeiro_jogador} jogou {jogada_do_primeiro_jogador} e o {segundo_jogador} jogou {jogada_do_segundo_jogador}\n"
    )
...
def quem_ganhou(
    ...
    if jogada_do_primeiro_jogador == jogada_do_segundo_jogador:
        ...
        (
            jogada_do_primeiro_jogador == "Pedra"
            and jogada_do_segundo_jogador == "Tesoura"
        )
        or (
            jogada_do_primeiro_jogador == "Papel"
            and jogada_do_segundo_jogador == "Pedra"
        )
        or (
            jogada_do_primeiro_jogador == "Tesoura"
            and jogada_do_segundo_jogador == "Papel"
        )
    ):
